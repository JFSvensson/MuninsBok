...
export const BAS_SIMPLIFIED: readonly Account[] = [
  ...
  {
    number: "1630",
    name: "Avräkning för skatter och avgifter",
    type: "ASSET",
    isVatAccount: false,
    isActive: true,
  },
  ...
  {
    number: "1930",
    name: "Företagskonto/checkräkning",
    type: "ASSET",
    isVatAccount: false,
    isActive: true,
  },
  ...
  {
    number: "2310",
    name: "Skulder till kreditinstitut långfristiga",
    type: "LIABILITY",
    isVatAccount: false,
    isActive: true,
  },
  {
    number: "2350",
    name: "Skulder till delägare långfristiga",
    type: "LIABILITY",
    isVatAccount: false,
    isActive: true,
  },
  ...
  {
    number: "2410",
    name: "Skulder till kreditinstitut kortfristiga",
    type: "LIABILITY",
    isVatAccount: false,
    isActive: true,
  },
  ...
  {
    number: "4600",
    name: "Legoarbete och underentreprenader",
    type: "EXPENSE",
    isVatAccount: false,
    isActive: true,
  },
  ...
  {
    number: "7519",
    name: "Arbetsgivaravgifter för semester",
    type: "EXPENSE",
    isVatAccount: false,
    isActive: true,
  },
  {
    number: "7570",
    name: "Särskild löneskatt på pensionskostnader",
    type: "EXPENSE",
    isVatAccount: false,
    isActive: true,
  },
 ...
 */
export function getAccountsByType(accounts: readonly Account[], type: Account["type"]): Account[] {
